...
import '../../../blocs/INVESTORPANEL/verifyPayment/verify_payment_bloc.dart';
...
class _PortfolioState extends State<PortfolioScreen> {
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    print('Payment Success - Order ID: ${response.orderId}');
  ...
  void _verifyPayment({
    ...
    // Create a new instance of VerifyPaymentBloc
    final verifyPaymentBloc = VerifyPaymentBloc(
      verifyPaymentRepository: getIt(),
    );

    // Add the event to verify payment
    verifyPaymentBloc.add(
      VerifyPaymentButtonPressed(
    ...
    verifyPaymentBloc.stream
        .listen((state) {
          ...
          if (state.postApiStatus == PostApiStatus.success) {
            ...
            // Close the verify payment bloc
            verifyPaymentBloc.close();
          }
